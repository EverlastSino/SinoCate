...
public class CateFlammableBlockRegister {
    public static void register(){
        ...
        FlammableBlockRegistry.getDefaultInstance().add(CateBlocks.Orange_Tree_Leaves, 100, 80);
        ...
        FlammableBlockRegistry.getDefaultInstance().add(CateBlocks.Sun_Drying_Tray, 600, 40);
    }
}
