...
public record MillingRecipeSerializer<T extends MillingRecipe>(
    ...
    public T read(Identifier identifier, PacketByteBuf packetByteBuf) {
        ...
        int rounds = packetByteBuf.readVarInt();
        return this.recipeFactory.create(identifier, ingredient, itemStack, results, rounds);
    }
    ...
    public void write(PacketByteBuf packetByteBuf, T millingRecipe) {
        ...
        //packetByteBuf.writeVarInt(millingRecipe.result.getMatchingStacks().length);
        //for (ItemStack itemStack : millingRecipe.result.getMatchingStacks()) {
