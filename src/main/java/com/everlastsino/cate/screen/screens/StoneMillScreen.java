...
public class StoneMillScreen extends HandledScreen<StoneMillScreenHandler> {
    ...
    private static final Identifier TEXTURE = new Identifier("cate", "textures/gui/container/stone_mill.png");
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        //绘制时间条儿
        this.drawTexture(matrices, this.x + 96, this.y + 58, 176, 36, this.handler.getTimerWidth(), 16);
    }
