...
public class CateItems {
    ...
    public static final Item Rolling_Pin = new Item(
            new FabricItemSettings().group(CateItemGroups.Cooker).maxCount(1).maxDamage(128));
    public static final Item Kitchen_Knife = new SwordItem(ToolMaterials.IRON, 2, -3.0f,
            new FabricItemSettings().group(CateItemGroups.Cooker));

    //中间产物
    public static final Item Orange_Peel = new Item(new FabricItemSettings().group(CateItemGroups.Plant));

    //农副产品
    public static final Item Paddy_Straw = new Item(new FabricItemSettings().group(CateItemGroups.Plant));
    public static final Item Osmanthus = new Item(new FabricItemSettings().group(CateItemGroups.Plant));
    public static final Item Orange = new FoodWithContainerItem(Orange_Peel, new FabricItemSettings()
            .group(CateItemGroups.Plant).food(
                    new FoodComponent.Builder().hunger(2).saturationModifier(0.2f).snack().alwaysEdible().build()));
    public static final Item Garlic_Leaf = new Item(new FabricItemSettings().group(CateItemGroups.Plant));
    public static final Item Garlic_Bolt = new Item(new FabricItemSettings().group(CateItemGroups.Plant));

    //食材
    public static final Item Rice = new Item(new FabricItemSettings().group(CateItemGroups.Plant));
    public static final Item Flour = new Item(new FabricItemSettings().group(CateItemGroups.Flour_Products));
    public static final Item Minced_Meat = new Item(new FabricItemSettings().group(CateItemGroups.Dishes));
    ...
    //猎物
    public static final Item Oyster = new Item(new FabricItemSettings().group(CateItemGroups.Plant));

    //调味品
    public static final Item Oyster_Sauce = new Item(new FabricItemSettings().group(CateItemGroups.Dishes));
    public static final Item Salt = new Item(new FabricItemSettings()
            .group(CateItemGroups.Dishes).recipeRemainder(Items.GLASS_BOTTLE));
    public static final Item Salt_Bucket = new Item(new FabricItemSettings()
            .recipeRemainder(Items.BUCKET).group(CateItemGroups.Dishes));
    public static final Item Tangerine_Peel = new Item(new FabricItemSettings().group(CateItemGroups.Dishes));
    public static final Item Crushed_Peanuts = new Item(new FabricItemSettings().group(CateItemGroups.Dishes));
    public static final Item Peanut_Filling = new Item(new FabricItemSettings().group(CateItemGroups.Dishes).maxDamage(5));

    //生食区
    public static final Item Raw_Soymilk = new Item(new FabricItemSettings().group(CateItemGroups.Dishes));
    public static final Item Green_Soybean = new Item(new FabricItemSettings().group(CateItemGroups.Dishes));
    public static final Item Baozi = new ItemWithToolTip("baozi", true,
            new FabricItemSettings().group(CateItemGroups.Dishes), Formatting.AQUA, Formatting.ITALIC);

    //熟食区
    public static final Item Osmanthus_Adzuki_Bean_Porridge = new StewItem(
            new FabricItemSettings().group(CateItemGroups.Dishes).food(
    ...
    public static final Item Cooked_Oyster = new Item(new FabricItemSettings()
            .group(CateItemGroups.Dishes).food(FoodComponents.COOKED_SALMON));
    public static final Item Soymilk = new SimpleDrinkItem(Items.GLASS_BOTTLE,
            new FabricItemSettings().recipeRemainder(Items.GLASS_BOTTLE).food(FoodComponents.HONEY_BOTTLE)
                    .group(CateItemGroups.Dishes).maxCount(16));
    public static final Item Cooked_Green_Soybean = new Item(new FabricItemSettings().group(CateItemGroups.Dishes)
    ...
    public static final Item Cooked_Baozi = new ItemWithToolTip("cooked_baozi", true,
            new FabricItemSettings().group(CateItemGroups.Dishes)
                    .food(new FoodComponent.Builder().hunger(6).saturationModifier(1.6f).meat().build()), Formatting.AQUA, Formatting.ITALIC);
    public static final Item Cured_Porkchop = new Item(new FabricItemSettings().group(CateItemGroups.Dishes));
    public static final Item Smoked_Porkchop = new Item(new FabricItemSettings()
            .group(CateItemGroups.Dishes).food(FoodComponents.COOKED_PORKCHOP));
    public static final Item Steamed_Dumpling = new Item(new FabricItemSettings().group(CateItemGroups.Dishes)
            .food(new FoodComponent.Builder().hunger(5).saturationModifier(1).build()));

    //刷怪蛋
    public static final Item Oyster_Spawn_Egg = new SpawnEggItem(CateEntities.Oyster_Entity,
            0x4f6a74, 0xbdbfa0, new FabricItemSettings().group(CateItemGroups.Plant));
    public static final Item Crab_Spawn_Egg = new SpawnEggItem(CateEntities.Crab_Entity,
            0xdd7e6b, 0xffd6ce, new FabricItemSettings().group(CateItemGroups.Plant));

    //方块物品
    //装饰方块
    public static final BlockItem Salt_Block = new BlockItem(CateBlocks.Salt_Block,
            new FabricItemSettings().group(CateItemGroups.Plant));
    ...
    public static final BlockItem Sun_Drying_Tray = new BlockItem(CateBlocks.Sun_Drying_Tray,
            new FabricItemSettings().group(CateItemGroups.Cooker));
    public static final BlockItem Hearth = new BlockItem(CateBlocks.Hearth,
            new FabricItemSettings().group(CateItemGroups.Cooker));
    ...
    public static final BlockItem Garlic = new BlockItem(CateCrops.Garlic,
            new FabricItemSettings().group(CateItemGroups.Plant));
    public static final BlockItem Peanut = new BlockItem(CateCrops.Peanut,
            new FabricItemSettings().group(CateItemGroups.Plant));
    ...
    public static void registerItems(){
        ...
        registerItem("crushed_peanuts", Crushed_Peanuts);
        registerItem("peanut_filling", Peanut_Filling);
        ...
        registerItem("crab_spawn_egg", Crab_Spawn_Egg);
