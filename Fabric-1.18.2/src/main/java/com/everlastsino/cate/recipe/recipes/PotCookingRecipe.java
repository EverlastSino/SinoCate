...
public class PotCookingRecipe implements Recipe<Inventory> {
    ...
    public int cookTime;
    public boolean decreaseWater;

    public PotCookingRecipe(Identifier id, Ingredient ingredient, ItemStack container, Ingredient result, float experience, int cookTime, boolean decreaseWater) {
        ...
        this.decreaseWater = decreaseWater;
    }

    @Override
    public ItemStack createIcon() {
        return new ItemStack(CateItems.Saucepan);
    }
