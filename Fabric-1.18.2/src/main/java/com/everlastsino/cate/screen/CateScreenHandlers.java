...
public class CateScreenHandlers {
    ...
    public static ScreenHandlerType<HearthScreenHandler> Hearth_ScreenHandler;
    ...
    public static void registerScreenHandlers(){
        ...
        Hearth_ScreenHandler = ScreenHandlerRegistry.registerExtended(
                new Identifier("cate", "hearth_screen_handler"), HearthScreenHandler::new);
    }
}
