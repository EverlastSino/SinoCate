...
public class EvaporationPanBlock extends Block {
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        boolean isCooking = blockState.isOf(Blocks.FIRE) || blockState.isOf(Blocks.SOUL_FIRE)
                || ((blockState.isOf(Blocks.CAMPFIRE) || blockState.isOf(Blocks.SOUL_CAMPFIRE)) && blockState.get(CampfireBlock.LIT))
                || (blockState.isOf(CateBlocks.Hearth) && blockState.get(HearthBlock.SITUATION) != HearthSituation.NONE);
