...
public class CateBlockEntities {
    ...
    public static BlockEntityType<HearthBlockEntity> Hearth_BlockEntity;
    ...
    public static void createBlockEntities(){
        ...
        Hearth_BlockEntity = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier("cate","hearth_block_entity"),
                FabricBlockEntityTypeBuilder.create(HearthBlockEntity::new, CateBlocks.Hearth).build());
    }
}
